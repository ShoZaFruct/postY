...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'updatedAt', type: 'string', nullable: false),
    ]
)]
readonly class UpdatePostByUuidAndAccountResponse implements \JsonSerializable
{
    ...
    public function jsonSerialize(): array
    {
        return [
            ...
            'updateAt' => $this->getUpdatedAt()->format('Y-m-d H:i:s'),
        ];
    }
}